#
#  Be sure to run `pod spec lint ImageFreeCut.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "ImageFreeCut"
  s.version      = "0.0.1"
  s.summary      = "A UIView subclass lets you draw a path over a image and crops thats part."
...
delegate method to retrive cropped image.
  ...
  s.source_files  = "ImageFreeCut/ImageFreeCutView.swift"
